...
const navigation = [
    ...
    { name: 'adminOrder', href: '/adminOrder', current: false },
                                    ...
                                    <div className="flex space-x-4">
                                        ...
                                        {navigation.map((item) => (
                                            <NavLink
                                                ...
                                                to={item.href}
                                                className={({ isActive }) => (
                                                    `rounded-md px-3 py-2 text-sm font-medium ${isActive ? 'bg-red-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'}`
                                                )} >
