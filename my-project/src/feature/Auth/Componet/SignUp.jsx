          ...
          <form noValidate className="space-y-6"
            onSubmit={handleSubmit((data) => {
              ...
              <div className="mt-2">
                <input
                  id="email"
                  {...register("email", { required: "email is required ", pattern: { value: "[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?", message: " you email syntax is not valid" } })}
                  type="email"
              ...
              <div className="mt-2">
                <input
                  ...
                  {...register("confirmPassword", {
                    required: "confirmPassword is required ", validate: (value, formValues) => value === formValues.password || "password is not matched"
                  })}
                  type="password"
                ...
                />
                <span className="text-red-500 capitalize">{errors?.confirmPassword?.message}</span>
